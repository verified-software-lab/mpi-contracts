...
public interface TypeFactory {
	...
	/**
	 * @return an instance of {@link AcslMPIBufType}
	 */
	AcslMPIBufType acslMPIBufType();
	
	/**
	 * 
	 * @return an instance of {@link AcslMPISigType}
	 */
	AcslMPISigType acslMPISigType();
	
	/**
	 * 
	 * @return an instance of {@link AcslMPISeqType}
	 */
	AcslMPISeqType acslMPISeqType();
	 ...
	 */
	SetType theSetType(Type elementType);
	...
	/**
	 * Returns the mathematical tuple type with the given sequence of component
	 * types.
	 * 
	 * @param componentTypes
	 *            an array containing component types
	 * @return the created tuple type
	 */
	TupleType tupleType(Type... componentTypes);
