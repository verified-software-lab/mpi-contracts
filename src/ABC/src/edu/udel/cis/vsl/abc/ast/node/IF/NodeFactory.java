...
public interface NodeFactory {
	 ...
	 * @return the created {@link MPICollectiveBlockNode}
	 */
	...
	/**
	 * creates a {@link MPIUsesNode}
	 * 
	 * @param source
	 *            the {@link Source} associated with the creating node.
	 * @param comms
	 *            the {@link SequenceNode} representing the set of expressions
	 *            of the MPI_Comm objects specified in the <code>mpi uses</code>
	 *            clause.
	 * @return the created {@link MPIUsesNode}
	 */
	MPIUsesNode newMPIUsesNode(Source source, SequenceNode<ExpressionNode> comms);
	
	/**
	 * Creates a new {@link CurlyBracedTermSetNode} representing an explicit
	 * set.
	 * 
	 * @param source
	 *            the {@link Source} of the creating node
	 * @param explicitElements
	 *            the set of explicit elements
	 * @return a new {@link CurlyBracedTermSetNode} representing an explicit set
	 */
	CurlyBracedTermSetNode newCurlyBracedTermSetNode(Source source,
			List<ExpressionNode> explicitElements);

	/**
	 * Creates a new {@link CurlyBracedTermSetNode} representing a set
	 * comprehension.
	 * 
	 * @param source
	 *            the {@link Source} of the creating node
	 * @param terms
	 *            the term part of the set comprehension, which consists of a
	 *            sequence of terms.
	 * @param binders
	 *            the binders part of the set comprehension
	 * @param pred
	 *            the predicate part iofn the set comprehension
	 * @return a new {@link CurlyBracedTermSetNode} representing a set
	 *         comprehension.
	 */
	CurlyBracedTermSetNode newCurlyBracedTermSetNode(Source source,
			SequenceNode<ExpressionNode> terms,
			SequenceNode<VariableDeclarationNode> binders, ExpressionNode pred);
	
	/**
	 * Creates a new {@link SeparatedNode}
	 * 
	 * @param source
	 *            the {@link Source} of the creating node
	 * @param arguments
	 *            the listed arguments of the SeparatedNode.
	 * @return a new {@link SeparatedNode}
	 */
	SeparatedNode newSeparatedNode(Source source,
			List<ExpressionNode> arguments);
