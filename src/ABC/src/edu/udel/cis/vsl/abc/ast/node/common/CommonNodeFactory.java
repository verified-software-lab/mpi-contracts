...
import static edu.udel.cis.vsl.abc.ast.node.IF.acsl.MPIContractAbsentEventNode.MPIAbsentEventKind.SENDFROM;
import static edu.udel.cis.vsl.abc.ast.node.IF.acsl.MPIContractAbsentEventNode.MPIAbsentEventKind.SENDTO;
import static edu.udel.cis.vsl.abc.ast.node.IF.acsl.MPIContractExpressionNode.MPIContractExpressionKind.MPI_ABSENT;
import static edu.udel.cis.vsl.abc.ast.node.IF.acsl.MPIContractExpressionNode.MPIContractExpressionKind.MPI_ABSENT_EVENT;
...
import edu.udel.cis.vsl.abc.ast.node.common.acsl.CommonCurlyBracedTermSetNode;
...
import edu.udel.cis.vsl.abc.ast.node.common.acsl.CommonMPIContractAbsentEventNode;
import edu.udel.cis.vsl.abc.ast.node.common.acsl.CommonMPIContractAbsentNode;
import edu.udel.cis.vsl.abc.ast.node.common.acsl.CommonMPIContractExpressionNode;
import edu.udel.cis.vsl.abc.ast.node.common.acsl.CommonMPIUsesNode;
...
import edu.udel.cis.vsl.abc.ast.node.common.acsl.CommonSeparatedNode;
...
import edu.udel.cis.vsl.abc.ast.node.common.omp.CommomOmpAtomicNode;
import edu.udel.cis.vsl.abc.ast.node.common.omp.CommonOmpDeclarativeNode;
import edu.udel.cis.vsl.abc.ast.node.common.omp.CommonOmpEndNode;
...
import edu.udel.cis.vsl.abc.ast.node.common.omp.CommonOmpSimdNode;
...
public class CommonNodeFactory implements NodeFactory {
	...
	public MPICollectiveBlockNode newMPICollectiveBlockNode(Source source,
			ExpressionNode mpiComm, SequenceNode<ContractNode> body) {
		return new CommonMPICollectiveBlockNode(source, mpiComm, body);
	}
	...
	@Override
	public MPIUsesNode newMPIUsesNode(Source source,
			SequenceNode<ExpressionNode> comms) {
		return new CommonMPIUsesNode(source, comms);
	}
	...
	@Override
	public CurlyBracedTermSetNode newCurlyBracedTermSetNode(Source source,
			List<ExpressionNode> explicitElements) {
		return new CommonCurlyBracedTermSetNode(source, explicitElements);
	}

	@Override
	public CurlyBracedTermSetNode newCurlyBracedTermSetNode(Source source,
			SequenceNode<ExpressionNode> terms,
			SequenceNode<VariableDeclarationNode> binders,
			ExpressionNode pred) {
		return new CommonCurlyBracedTermSetNode(source, terms, binders, pred);
	}

	@Override
	public SeparatedNode newSeparatedNode(Source source,
			List<ExpressionNode> arguments) {
		return new CommonSeparatedNode(source, arguments);
	}
}
